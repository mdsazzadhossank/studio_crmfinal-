    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-gray-200">
        <div className="flex items-center">
          ...
          <div>
            <h2 className="text-2xl font-black text-gray-900">{client.name || 'Unnamed Client'}</h2>
            <p className="text-sm font-medium text-gray-500">{client.company || 'No Company'} <span className="mx-2">•</span> VIP Client</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-indigo-600 rounded-2xl shadow-sm border border-indigo-700 p-6 text-white relative overflow-hidden">
          ...
          <p className="text-3xl font-black mb-1">৳{(client.balance || 0).toLocaleString()}</p>
        </div>
                      ...
                      <tr key={hist.id} className="border-b border-gray-50 text-sm font-medium text-gray-800 hover:bg-gray-50/50">
                        {editingAdHistId === hist.id ? (
                          ...
                          <>
                            ...
                            <td className="p-3 font-bold text-gray-800">${(hist.clientBill || 0).toFixed(2)}</td>
                            <td className="p-3 text-right">${(hist.actualCost || 0).toFixed(2)}</td>
                            ...
                            <td className="p-3 text-right text-emerald-600 font-bold">৳{(hist.profit || 0).toLocaleString()}</td>
                            <td className="p-3 text-right text-red-600">৳{(hist.walletEffect || 0).toLocaleString()}</td>
                            <td className="p-3 text-right flex items-center justify-end gap-2">
